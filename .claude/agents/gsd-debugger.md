...
<required_reading>
@/home/fabio/dev/board/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/fabio/dev/board/.claude
                  → checks /home/fabio/dev/board/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/fabio/dev/board/.claude/get-shit-done
                  → writes to /home/fabio/dev/board/.claude/get-shit-done/hooks/
...
@/home/fabio/dev/board/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/fabio/dev/board/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
