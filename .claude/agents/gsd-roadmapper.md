...
Reference full template: `/home/fabio/dev/board/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/fabio/dev/board/.claude/get-shit-done/templates/state.md`.
