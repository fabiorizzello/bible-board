...
```bash
AUDITOR_MODEL=$(node "/home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/fabio/dev/board/.claude/agents/gsd-eval-auditor.md for instructions.
