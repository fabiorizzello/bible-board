...
```bash
cp "/home/fabio/dev/board/.claude/get-shit-done/USER-PROFILE.md" "/home/fabio/dev/board/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/home/fabio/dev/board/.claude/USER-PROFILE.backup.md"
```
