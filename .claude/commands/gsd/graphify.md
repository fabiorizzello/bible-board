...
Knowledge graph is disabled. To activate:
  ...
  node /home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/home/fabio/dev/board/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
