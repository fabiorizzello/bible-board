        ...
        <div className="rounded-[2rem] border border-primary/15 bg-white/85 p-8 shadow-xl shadow-primary/10 backdrop-blur">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-3">
              ...
              <h1 className="font-heading text-3xl text-ink">Workspace Demo</h1>
              <p className="max-w-2xl text-base leading-7 text-ink/80">
                Questa vista mostra i componenti iniziali anche se auth o Jazz
                non sono ancora pronti nel browser.
              </p>
            </div>
          ...
          <article className="rounded-[1.75rem] border border-primary/10 bg-white p-6 shadow-lg shadow-primary/5">
            ...
            <dl className="mt-4 space-y-3 text-sm text-ink/75">
              <div className="flex items-center justify-between gap-4">
                <dt>Tag censiti</dt>
                <dd className="font-semibold text-ink">0</dd>
              </div>
              <div className="flex items-center justify-between gap-4">
                <dt>Board salvati</dt>
                <dd className="font-semibold text-ink">0</dd>
              ...
              <div className="flex items-center justify-between gap-4">
                <dt>Modalita</dt>
                <dd className="font-semibold text-ink">Preview</dd>
              </div>
            </dl>
          </article>
        </div>
